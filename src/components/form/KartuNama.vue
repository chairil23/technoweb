  ...
  <div>
    <v-layout>
     ...
     <v-layout>
      ...
      <v-flex md4>
        <v-text-field class="pt-1 pl-4" v-model="item.nama" single-line bottom></v-text-field>
      </v-flex>
      <v-flex md2>
     ...
     <v-layout>
      ...
      <v-flex md4>
        <v-text-field class="pt-1 pl-4" v-model="item.jabatan" single-line bottom></v-text-field>
      </v-flex>
      <v-flex md1>
