<template>
  <div>
    <v-layout>
     ...
     <v-layout>
      <v-flex md1>
        <v-subheader>Model Bantal </v-subheader>
      </v-flex>
     <v-flex md4>
        <v-select class="pt-1 pl-4" v-model="item.model.text" :items="jenis[0].materials" item-text="model_bantal" item-value="model_bantal" single-line bottom></v-select>
      </v-flex>
       <v-flex md1>
        <v-subheader>Kain </v-subheader>
      </v-flex>
      <v-flex md4>
        <v-select class="pt-1 pl-4" v-model="item.kain.text" :items="jenis[0].materials" item-text="jenis_kain" item-value="jenis_kain" single-line bottom></v-select>
      </v-flex>
    </v-layout>
     ...
     <v-layout>
      ...
      <v-flex md4>
        <v-select class="pt-1 pl-4" v-model="item.warna.text" :items="warna" item-text="text" item-value="text" single-line bottom></v-select>
      </v-flex>
    </v-layout>
